...
folder are mapped to the application's root namespace, 'ExamplesExtJS'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ExamplesExtJS"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ExamplesExtJS' in the same way
as `"ExamplesExtJS/sass/src"`.
